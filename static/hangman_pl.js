...
function check(number)
{
    ...
    if (word === hidden_word)
    {
        document.getElementById("alphabet").innerHTML =
            '<span id="win-text">WYGRANA!</span> Hasło prawidłowe!<br/>' + word +
    ...
    {
        document.getElementById("alphabet").innerHTML =
            '<span id="loss-text">PRZEGRANA!<br/></span> Poprawne hasło to:<br/>' + word +
            '<br/><br/><span class="reset" onclick="location.reload()">Jeszcze raz?</span>';
    }
